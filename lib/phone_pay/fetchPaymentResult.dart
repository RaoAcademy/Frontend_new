...
class FetchPaymentStatus extends StatefulWidget {
  FetchPaymentStatus({Key? key,required this.amount,required this.coins,required this.subId,required this.mTID}) : super(key: key);
              ...
              body: Column(
                children: [
                  ...
                  Expanded(
                    ...
                    child: SvgPicture.asset("assets/images/other/success_icon.svg",height: 80,width: 80,),
                  ),
                  Expanded(
            ...
            body: Column(
              children: [
                ...
                Expanded(
                  ...
                  child: Image.asset("assets/images/other/cross.png",scale: 4,),
                ),
                Expanded(
