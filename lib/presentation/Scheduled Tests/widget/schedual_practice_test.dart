...
class SchedualPracticeTestScreen extends StatefulWidget {
  const SchedualPracticeTestScreen({super.key});

  @override
  State<SchedualPracticeTestScreen> createState() => _SchedualPracticeTestScreenState();
}

class _SchedualPracticeTestScreenState extends State<SchedualPracticeTestScreen> {
  @override
  void initState() {
    super.initState();
  ...
  Widget build(BuildContext context) {
    return Consumer<ScheduleTestProvider>(builder: (context, value, child) {
      return value.missed == null || value.missed!.tests.isEmpty ? Center(child: Text("Currently you have no Missed tests"),) :ListView.builder(
        shrinkWrap: true,
        itemCount: 3,
        itemBuilder: (context, index) {
          TestEntity testEntity = Provider.of<HomeProvider>(context,
              listen: false)
              .homeEntity
              .recommendations![0];
          return   Padding(
            ...
            child: Row(
              children: [
                Icon(Icons.circle,color: LoopsColors.colorGrey,size: 20.w,),
                Padding(
                                  ...
                                  children: [
                                    ...
                                    Row(
                                      ...
                                      children: [
                                        Row(
                                          children: [
                                            Icon(Icons.schedule,size: 16,color: LoopsColors.colorBlack.withOpacity(0.6)),
                                            Text(" 05:07 PM",style: TextStyle(
                                              fontSize: 12,
                                              fontWeight: FontWeight.w600,
